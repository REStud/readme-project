...
def read_inputs(datadir: Path) -> Tuple:
    ...
    varmus_xyz0 = varbigmus_hat[:n_prod_categories,
                                n_prod_categories:(n_prod_categories + ncat_men)]
    varmus_xy0t = varbigmus_hat[:n_prod_categories,
                                (n_prod_categories + ncat_men):]
    varmus_x0z0 = varbigmus_hat[n_prod_categories:(n_prod_categories + ncat_men),
                                n_prod_categories:(n_prod_categories + ncat_men)]
    varmus_x00y = varbigmus_hat[n_prod_categories:(
        n_prod_categories + ncat_men), (n_prod_categories + ncat_men):]
    varmus_0y0t = varbigmus_hat[(
        n_prod_categories + ncat_men):, (n_prod_categories + ncat_men):]
    varmus = (varmus_xyzt, varmus_xyz0, varmus_xy0t,
